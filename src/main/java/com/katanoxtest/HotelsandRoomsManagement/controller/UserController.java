...
import com.katanoxtest.HotelsandRoomsManagement.repositories.UserRepository;
...
public class UserController {
	 ...
	 */
	@GetMapping("/users/{id}")
	public HttpEntity<User> getUsersById(@PathVariable(value = "id") Long userId) throws ResourceNotFoundException {
